...
export class DigitalVoucherCancellationProcessorStack extends cdk.Stack {
  constructor(scope: cdk.Construct, id: string, props?: cdk.StackProps) {
    ...
    const createAlarm = (lambdaFn: lambda.Function) => {
        const alarm = new cloudwatch.Alarm(this, 'DigitalVoucherCancellationProcessorAlarm', {
            ...
            metric: new cloudwatch.Metric({
                ...
                metricName: 'Errors',
                dimensions: {Name: 'FunctionName', Value: lambdaFn.functionName}
            }),
        ...
        // TODO
        // let topic = new sns.Topic(this, `arn:aws:sns:${region}:${account}:fulfilment-dev`)
        let topic = new sns.Topic(this, `arn:aws:sns:TODO:TODO:fulfilment-dev`)
    ...
    const digitalVoucherCancellationProcessorSchedule = createDigitalVoucherCancellationProcessorSchedule(digitalVoucherCancellationProcessorLambda)
      ...
      // TODO
    if (stageParameter.valueAsString == "PROD") {
        createAlarm(digitalVoucherCancellationProcessorLambda)
    }
  }
}
